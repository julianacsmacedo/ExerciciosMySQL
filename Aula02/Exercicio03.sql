...
insert into tb_categoria(categoria, loja, localidade) values ("Higiene", "Drogaria Solo", "Zona Norte");
insert into tb_categoria(categoria, loja, localidade) values ("Medicamentos", "MedicaJá", "Centro");
insert into tb_categoria(categoria, loja, localidade) values ("Perfumaria", "Yafarma", "Zona Leste");
